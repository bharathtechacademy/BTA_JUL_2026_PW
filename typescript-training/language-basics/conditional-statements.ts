//Conditional Statements : The statements along with conditions 
...
//There are two different types of conditional statements available. 

//1.if-else conditional statement => When we don't know the result of the condition before itself 
//2.switch case conditional statement => When we know the result, but we want to choose one option among multiple options available 
...
switch (env) {
    ...
    case "qa":
        ...
        console.log("launch the application with db.qa.amazon.com");
        console.log("launch the application with aws.qa.amazon.com");
        break;
    case "prod":
